...
class ChatBot:
    ...
    def preload_conversation(self, conversation_history=None):
        if isinstance(conversation_history, list):
            ...
            self.conversation_history = [
                self._construct_message("From now on, return the output as JSON object that can be loaded in Python with the key as \'text\'. For example"),
                self._construct_message("{'text': 'Sure, I can return the output as a regular JSON object with key as 'text'"),
            ]
